...
public class MockManager {
    public static var fail: ((message: String, sourceLocation: SourceLocation)) -> Void = { (arg) in let (message, sourceLocation) = arg; XCTFail(message, file: sourceLocation.file, line: sourceLocation.line) }
